    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Tarik saldo komisi Anda</p>
        </div>
        <WithdrawalForm userId={userId} balance={user?.balance ? Number(user.balance) : 0} />
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <StatCard title="Saldo" value={formatCurrency(user?.balance || 0)} icon={Wallet} color="blue" />
      </div>
